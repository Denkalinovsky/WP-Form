...
<html lang="ru"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <!-- <link rel="dns-prefetch" href="https://s.w.org/">
            <script type="text/javascript">
                window._wpemojiSettings = {"baseUrl":"https:\/\/s.w.org\/images\/core\/emoji\/13.0.1\/72x72\/","ext":".png","svgUrl":"https:\/\/s.w.org\/images\/core\/emoji\/13.0.1\/svg\/","svgExt":".svg","source":{"concatemoji":"https:\/\/#\/wp-includes\/js\/wp-emoji-release.min.js?ver=5.6.1"}};
    ...
    img.emoji {
        ...
        <!-- <link rel="stylesheet" id="test-app-css" href="./assets/css/app.css" type="text/css" media="all"> -->
    <script type="text/javascript" id="jquery-core-js-extra">
    // <![CDATA[ 
    var _ajax = "<?php echo site_url()?>/wp-admin/admin-ajax.php";
    // ]]>
    </script>
...
<!-- <script type="text/javascript" src="./assets/js/app.js" id="app-js"></script> -->
